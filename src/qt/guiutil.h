...
/** Utility functions used by the Avantage Qt UI.
 */
namespace GUIUtil
{
...
// Render Avantage addresses in monospace font
...
// Parse "avantage:" URI into recipient object, return true on successful parsing
