...
public:
    ...
    void setZAvantageControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzAVN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzAVN_clicked();
    void on_pushButtonZAvantageControl_clicked();
