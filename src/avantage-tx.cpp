...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Avantage avantage-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  avantage-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded avantage transaction") + "\n" +
                               "  avantage-tx [options] -create [commands]   " + _("Create hex-encoded avantage transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded avantage transaction
